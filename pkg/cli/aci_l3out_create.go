...
// l3outCreateCmd creates an ACI L3 outside network connection.
var (
	l3outCreateCmd = &cobra.Command{
		Use:   "create",
		Short: "Create an ACI L3 outside network connection",
		Long:  `Create an ACI L3 outside network connection`,
		Run:   L3outCmd,
	}
)
...
// L3outCmd creates an ACI L3 outside network connection for a tenant.
func L3outCmd(cmd *cobra.Command, args []string) {
