...
// vrfListCmd lists virtual routing and forwarding (vrf) instances for a tenant.
var vrfListCmd = &cobra.Command{
	Use:   "list",
	Short: "Lists virtual routing and forwarding (vrf) instances for a tenant",
	Long:  `Lists virtual routing and forwarding (vrf) instances for a tenant`,
	Run:   runVRFListCmd,
}
