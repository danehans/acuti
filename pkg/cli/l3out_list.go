...
// l3ListCmd lists L3 outside network connections for a tenant.
var l3ListCmd = &cobra.Command{
	Use:   "list",
	Short: "Lists L3 outside network connections for a tenant",
	Long:  `Lists L3 outside network connections for a tenant.`,
	Run:   runL3outListCmd,
}
