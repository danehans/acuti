...
// vrfCreateCmd creates a virtual routing and forwarding (vrf) instance.
var (
	vrfCreateCmd = &cobra.Command{
		Use:   "create",
		Short: "Create a virtual routing and forwarding (vrf) instance",
		Long:  `Create a virtual routing and forwarding (vrf) instance`,
		Run:   runVRFCreate,
	}
)
...
func init() {
	...
	vrfCreateCmd.Flags().StringVar(&aciFlags.descr, "descr", "", "Description of vrf")
